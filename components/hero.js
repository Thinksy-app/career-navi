...
import heroImg from "../public/img/cow-hero.png";
        ...
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            <h1 className="text-4xl font-bold leading-snug tracking-tight text-gray-800 lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight dark:text-white">
              Hi Calli, <br />
              Here’s what you’ve been up to at work
            </h1>
            <p className="py-5 text-xl leading-normal text-black-500 lg:text-xl xl:text-2xl dark:text-gray-300">
              Keep it up! Consistency is key to reaching your goals. So far you’ve logged ## times in Career Navi.
            </p>
            ...
            <div className="flex flex-col items-start space-y-3 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row">
              <a
                ...
                target="_blank"
                rel="noopener"
                className="px-8 py-4 text-lg font-medium text-center text-black bg-amber-400 rounded-md ">
                Get my summary
              </a>
              <a
                href="https://web3templates.com/templates/nextly-landing-page-template-for-startups"
                target="_blank"
                rel="noopener"
                className="px-8 py-4 text-lg font-medium text-center text-black bg-trueGray-100 rounded-md ">
                View my log
              </a>
            </div>
          </div>
